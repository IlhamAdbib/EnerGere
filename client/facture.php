...
if ($stmt->rowCount() > 0) {
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)) {
        ...
        if ($row['anomalie'] == 1) {
            echo "<td style='color: white; background-color: red; padding: 5px; border-radius: 5px;'>1</td>"; // Display anomaly status with red background
        } else {
            echo "<td style='color: white; background-color: green; padding: 5px; border-radius: 5px;'>0</td>"; // Display no anomaly status with green background
        }
        echo "<td>";
